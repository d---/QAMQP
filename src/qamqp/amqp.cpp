...
void ClientPrivate::init(QObject *parent) {
	...
	QObject::connect(network_, SIGNAL(method(const QAMQP::Frame::Method &)), connection_, SLOT(_q_method(const QAMQP::Frame::Method &)));
...
Exchange *ClientPrivate::createExchange(int channelNumber, const QString &name) {
	...
	QObject::connect(network_, SIGNAL(method(const QAMQP::Frame::Method &)),exchange_, SLOT(_q_method(const QAMQP::Frame::Method &)));
...
Queue *ClientPrivate::createQueue(int channelNumber, const QString &name) {
	...
	QObject::connect(network_, SIGNAL(method(const QAMQP::Frame::Method &)), queue_, SLOT(_q_method(const QAMQP::Frame::Method &)));
	QObject::connect(network_, SIGNAL(content(const QAMQP::Frame::Content &)), queue_, SLOT(_q_content(const QAMQP::Frame::Content &)));
	QObject::connect(network_, SIGNAL(body(int, const QByteArray &)), queue_, SLOT(_q_body(int, const QByteArray &)));
